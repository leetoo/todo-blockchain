...
Our app have only one important dependency:
* scorex-core

  * The actual blockchain record technology. Physical format, validation rules, etc.
  * The book-keeping system and/or other data payloads format within the blocks
